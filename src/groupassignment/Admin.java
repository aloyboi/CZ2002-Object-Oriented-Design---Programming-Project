...
public class Admin extends AllTXT {
		...
		System.out.println("Enter the Course Code of the Course to Update: ");
		 ...
		 for(int i=0;i<courselist.size();i++)
		 {
			 ...
			 case 1: 
	        		...
	        		System.out.print(sc.nextLine());
	            	courselist.get(i).setcourseName1(sc.nextLine().toUpperCase());
	            	break;
	            case 2: 
			 ...
			 //help pls :(       	 
			        				 ...
			        				 //if there is an existing index number of that course, will not update
			        				 //for index list, if index number in index list = new index number,
			        				/* for(int x=0; x<indexlist.size();x++) {
			        				 if((indexlist.get(x).getindexNum().equalsIgnoreCase(newIndexNum))){
			        					 entry2 = false;
			        					 break;
			        				 }
			        				 else if(entry2==true) {
	                ...
	                //{
	                	//System.out.println("Index number already exists! Please try again!");
	                	//findVacancy();
	               // }
	            ...
	            case 5:
	            	...
	            	System.out.println("Enter Exisiting Index Number To Change Vacancy: ");   
	                indexNum = sc.next();
	                for(int j=0;j<indexlist.size();j++) {
       				 if(indexlist.get(j).getcourseCode1().equalsIgnoreCase(courseEntry)){
       						 if(indexlist.get(j).getindexNum().equalsIgnoreCase(indexNum)) {
       							entry3=true;
			        				 ...
			        				 indexlist.get(j).setVacancy(newVacancy);	 
				        				...
				        				while (count>0) {
			 							...
			 							System.out.println("Waitlist has been updated!");
			 							break;
			        				 } 
			        						}
			        				 catch (Exception e){
...
public void findVacancy() throws Exception
{
 ...
 public void printStudentsByIndex() throws Exception
 {
	 ...
	 for(int i=0;i<courselist.size();i++)
	 {
		 ...
		 //String index=indexlist.get(j).getindexNum();
		 ...
		 for(int k=0;k<registeredCourseslist.size();k++)
		 {
			 ...
			 {
				 String matric=registeredCourseslist.get(j).getMatricID();
